...
const MobileFilterModal = ({ showMobileAdvanced, setShowMobileAdvanced, tempFilters, setTempFilters }) => {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <motion.div
        ...
        className="bg-gray-900 rounded-xl p-6 w-full max-w-md mx-4 relative"
      >
        <button
